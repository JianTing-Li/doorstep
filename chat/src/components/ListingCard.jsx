...
import { availabilityLabel, priceLabel } from "../lib/booking.js";
...
export default function ListingCard({
  ...
  return (
    ...
    <article
      className={`listing-card listing-card-tappable ${isOpen ? "is-open" : ""} ${disabled ? "is-disabled" : ""}`}
      role="button"
    ...
    >
      <div className="listing-card-head">
        ...
        <p className="listing-card-availability">{availabilityLabel(listing)}</p>
